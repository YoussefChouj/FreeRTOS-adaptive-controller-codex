...
#define configQUEUE_REGISTRY_SIZE				8                       //��Ϊ0ʱ��ʾ���ö��м�¼�������ֵ�ǿ���
                                                                        //��¼�Ķ��к��ź��������Ŀ��
#define configCHECK_FOR_STACK_OVERFLOW			2                       /* stack-overflow detection (method 2: sentinel byte check on every context switch). Hook: USER/main.c::vApplicationStackOverflowHook — writes g_stack_overflow_marker / g_stack_overflow_task_crc so livewatch can read the offending task name post-mortem. */
                                                                        //�û������ṩһ��ջ������Ӻ��������ʹ�õĻ�
                                                                        //��ֵ����Ϊ1����2����Ϊ������ջ�����ⷽ����
#define configUSE_RECURSIVE_MUTEXES				1                       //Ϊ1ʱʹ�õݹ黥���ź���
#define configUSE_MALLOC_FAILED_HOOK			1                       /* 1=use malloc-failure hook (fault_capture.c wires it) */
...
#define INCLUDE_uxTaskGetStackHighWaterMark     1                       // enable uxTaskGetStackHighWaterMark() API; per-task call sites added in follow-on commits (Frame B HWM telemetry)
