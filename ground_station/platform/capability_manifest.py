...
def get_panels() -> list[dict[str, Any]]:
    ...
    panel_meta_defaults = {
        "Flight Status": {"workspace": "overview control", "gates": []},
        "Safety Limits": {"workspace": "overview control", "gates": []},
        "Command Panel": {"workspace": "control", "gates": ["connected", "disarmed"]},
        "Time Series": {"workspace": "overview telemetry", "gates": []},
        ...
        "Bandwidth Manager": {"workspace": "telemetry diagnostics", "gates": []},
        "FFT Spectrum": {"workspace": "telemetry diagnostics", "gates": []},
    ...
    plugin_files = [
        ...
        ("status-panel.js", "Flight Status", ["overview", "control"], [], "Flight status, arming state, flight mode, battery, and safety flags"),
        ...
        ("safety-panel.js", "Safety Limits", ["overview", "control"], [], "Ground station safety limits and speed/angle parameter adjustments"),
        ...
        ("time-series-panel.js", "Time Series", ["overview", "telemetry"], [], "Real-time multi-variable time-series plot with bounded ring buffer"),
        ("fft-panel.js", "FFT Spectrum", ["telemetry", "diagnostics"], [], "Fast Fourier Transform frequency spectrum visualization"),
        ("bandwidth-panel.js", "Bandwidth Manager", ["telemetry", "diagnostics"], [], "Telemetry slot bandwidth, packet loss, and link budget monitor"),
    ...
    keys_read_map = {
        "overview-panel.js": [
            ...
            "status.arm", "status.estimator_ready", "status.flymode", "status.rc_authority", "status.sbus", "status.vbat",
        ],
        "status-panel.js": [
            "c.gyro_x", "c.gyro_y", "c.gyro_z",
            ...
            "status.of_hold", "status.rc_authority", "status.sbus", "status.status_bits",
